...
public class NotiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("http://m3day.cafe24.com/notification");
    ...
    public class misoWeb3 extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest urls) {
            ...
            if (url.startsWith("http://m3day.cafe24.com/board")) {
                if (url.startsWith("http://m3day.cafe24.com/board/daytime")) {
                    Intent i = new Intent(getApplicationContext(), MainActivity.class);
                    String status = "profile";
                    i.putExtra("status",status);
                    startActivity(i);
                } else if (url.startsWith("http://m3day.cafe24.com/findfriend")) {
                    Intent i = new Intent(getApplicationContext(), MainActivity.class);
                ...
                String accountID = url.replace("http://m3day.cafe24.com/mypage","");
                intent.putExtra("accountID",accountID);
                startActivity(intent);
            } else if(url.startsWith("http://m3day.cafe24.com/login")) {
